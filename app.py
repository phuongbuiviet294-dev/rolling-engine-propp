...
class SignalRecord:
    ...
    locked_window: Optional[int] = None
    lock_reason: str = ""
    state_version: str = "V66_ROBUST_LIVE_13D"
...
def ensure_ctx_fields(ctx: EngineContext) -> EngineContext:
    ...
    ctx.state_version = "V66_ROBUST_LIVE_13D"
...
def save_live_state(ctx: EngineContext) -> None:
    ...
    data = {
        ...
        "state_version": getattr(ctx, "state_version", "V66_ROBUST_LIVE_13D"),
