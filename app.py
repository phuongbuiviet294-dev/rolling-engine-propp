...
MODES = [
    ...
    {"name": "5v3", "top_windows": 5, "vote_required": 4, "window_min": 6, "window_max": 22},
...
st.write("Relock Rule 1:", f"loss_streak >= {PHASE_LOSS_STREAK_RELOCK} AND phase_group_profit < 0")
