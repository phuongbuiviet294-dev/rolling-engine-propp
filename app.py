...
# ===== AI WINDOW SEARCH =====
    ...
    if len(engine)>=90 and next_signal is None:
        ...
        for w in WINDOW_RANGE:
            ...
            for j in range(len(engine)-60,len(engine)):
...
# ===== ENTROPY FILTER =====
        ...
        probs=[v/30 for v in freq.values()]
...
st.title("⚡ QUANT ADAPTIVE ENGINE")
...
st.caption("QUANT ADAPTIVE ENGINE | AI Window | Entropy | Regime | Dominance")
