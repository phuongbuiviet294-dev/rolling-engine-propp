...
MODES = [
    {"name": "4v3", "top_windows": 3, "vote_required": 2, "window_min": 6, "window_max": 22},
    {"name": "5v4", "top_windows": 5, "vote_required": 3, "window_min": 6, "window_max": 22},
...
def simulate_engine(numbers, groups, colors):
    ...
    for i in range(start_replay, len(groups)):
        ...
        if trade and used_keep:
            state = "TRADE_KEEP"
        elif trade and pattern_match_vote:
            state = "TRADE_WINDOW_PATTERN"
        elif trade:
            state = "TRADE"
        elif new_signal and pattern_match_vote:
...
# ================= UI =================
st.title("🎯 Auto Relock Engine | Window + Pattern Match + Color Bet")
